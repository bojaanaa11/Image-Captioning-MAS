...
num_workers = 0 if start_epoch > 0 else 2
...
cnn_num_of_layers_to_unfreeze = 2
...
def download_coco_dataset():
    ...
    dataset_dir = os.path.expanduser(
        "/home/obojana/.cache/kagglehub/datasets/awsaf49/coco-2017-dataset/versions/2/coco2017/coco2017/coco2017"
    )
...
if __name__ == "__main__":
    ...
    n_parameters = sum(p.numel() for p in cnn_encoder.parameters() if p.requires_grad) + sum(p.numel() for p in transformer_decoder.parameters() if p.requires_grad)
